...
<body>
    <div class="container-fluid justify-content-center">
			<h2 class="row justify-content-md-center heading">Serving Employee</h2>
			<h4 class="row justify-content-md-center">Click on employee to update or edit info</h4>
            <div class="col middle">
                <div class="col justify-content-center form-col">
					<div class="col">
						@foreach ($servingEmployee as $item)
							<h4>
								<li>
									<a href="/serving_employee/{{$item->id}}/edit">{{$item->fname}}</a> <label>{{$item->job_title}}</label>
								</li>
							</h4>
						@endforeach
					</div>
