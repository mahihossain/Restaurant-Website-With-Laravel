...
<body>
    ...
    <div class="row " id="preloader">
     ...
     <header>
          ...
          <div id="logo_center" >
            <div class="big_logo">
               <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" 
                    ...
                    <style type="text/css">
                    .st0{fill:rgba(0, 0, 0, 0.5);stroke:rgba(214, 242, 2, 0.9);stroke-width:4.5;stroke-linejoin:round;stroke-miterlimit:10;}
                    </style>
                    <g>
      ...
      <video poster="{{ secure_asset('video/bg.jpg') }}" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop" >
        <source src="{{ secure_asset('video/mergeFood720p.mp4') }}" type="video/mp4">
      </video>
    </header>
    <!--............ logo ..............-->
