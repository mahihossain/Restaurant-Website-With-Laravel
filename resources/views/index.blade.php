                            ...
                            <div class="media">
                              ...
                              <div class="media-body">
                                <div class="overview">
                                  ...
                                  <div class="details">Developer / SoftBee</div>
                                  <div class="star-rating">
                                    <ul class="list-inline">
                                      <li class="list-inline-item"><i class="fas
                                       fa-star"></i></li>
                                      <li class="list-inline-item"><i class="fas
                                       fa-star"></i></li>
                                      <li class="list-inline-item"><i class="fas
                            ...
                            <div class="media">
                              ...
                              <div class="media-body">
                                <div class="overview">
                                  ...
                                  <div class="details">HR Manager / DevCorp</div>                      
                                  <div class="star-rating">
                                    <ul class="list-inline">
                                      <li class="list-inline-item"><i class="fas fa-star"></i></li>
                                      <li class="list-inline-item"><i class="fas fa-star"></i></li>
                        ...
                        <div class="col-sm-6">
                          <div class="testimonial-wrapper">
                            ...
                            <div class="media">
                              ...
                              <div class="media-body">
                                <div class="overview">
                                  <div class="name"><b>Ayesha Siddique</b></div>
                            ...
                            <div class="media">
                              ...
                              <div class="media-body">
                                <div class="overview">
                                  ...
                                  <div class="details">Market Analyst / RealSearch</div>
                                  <div class="star-rating">
                                    <ul class="list-inline">
                                      <li class="list-inline-item"><i class="fas fa-star"></i></li>
                                      <li class="list-inline-item"><i class="fas fa-star"></i></li>
                            ...
                            <div class="media">
                              ...
                              <div class="media-body">
                                <div class="overview">
                                  ...
                                  <div class="details">Designer / UniqueDesign</div>
                                  <div class="star-rating">
                                    <ul class="list-inline">
                                      <li class="list-inline-item"><i class="fas fa-star"></i></li>
                                      <li class="list-inline-item"><i class="fas fa-star"></i></li>
